...
const ImageClipBox = ({ source, clipClass }) => {
  return (
    <div className={clipClass}>
      <img src={source} alt="contact" />
    </div>
  );
};
  ...
  return (
    <div id="contact" className="my-20 min-h-96 w-screen px-10">
      <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
        <div className="absolute -left-20 top-0 h-full hidden w-72 overflow-hidden sm:block lg:left-20 lg:w-96">
          <ImageClipBox
